...
namespace HGR
{
    ...
    struct Net
    {
        ...
        bool is_double_pin();
        bool is_multi_pin();
        void get_routing_space(int _bufferDistance, set<int> &_rSpace);
        void get_routing_space(int _pin1, int _pin2, int _bufferDistance, set<int> &_rSpace);
    };
    ...
    struct Gcg
    {
        ...
        Gcg() : direction(VERTICAL), orig(0), stepNum(0), stepSize(0) {}
    };
    ...
    class Circuit
    {
        ...
        public:
            ...
            int write_iccad2019_guide(char* path);
