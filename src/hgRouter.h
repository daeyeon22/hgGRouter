...
namespace HGR
{
    ...
    /* Svg Image */
    void create_plot(int _net);
    void create_congestion_map(int _layer);
    ...
    Panel* get_panel(int _col, int _row, int _layer, int _dir);
    /* Track Assignment */
    void panel_routing();
    bool track_assignment(int _col, int _row, int _layer, int _dir, vector<pair<int,int>> &_segs);
    ...
    bool check_congested_region(int _net);
    /*  */
    bool route_all();
