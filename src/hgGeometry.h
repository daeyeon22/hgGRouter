...
namespace HGR
{
    ...
    struct Ext
    {
        ...
        Ext() : pin(0), layer(0), track(0), player(0), penalty(0.0), useVia(true) {}
        Ext(const Ext& _ext) :
            pin(_ext.pin), layer(_ext.layer), track(_ext.track), player(_ext.player), access(_ext.access), via(_ext.via), useVia(_ext.useVia),
    ...
    class Router
    {
      ...
      public:
        ...
        bool is_accessible(int _pin, int _track);
